          ...
          <div>
            ...
            <Segment className="statusComponent">
              ...
              <div className="connectionForm">
                <Form
                  className={
                    formErrors['account'] || formErrors['password']
                      ? 'warning'
                      : ''
                  }
                ...
                >
                  ...
                  <div className="action">
                    <Button type="submit" disabled={!connected} color="teal">
                      Edit
                    </Button>
                  </div>
                </Form>
              ...
              <Segment className="messagingComponent">
                <div className="form-wrapper">
                  ...
                  <div className="messagingForm">
                    <Form
                      className={
                        formErrors['messagingAddress'] ? 'warning' : ''
                      }
                      onSubmit={handleSetMessagingAccount}
                    >
                      <Form.Field>
                        <Form.Input
                          error={formErrors['messagingAddress']}
                          name="messagingAddress"
                          placeholder="^[Ada{}}sdS//s?]$"
                          value={messagingAddress}
                          onChange={handleChange}
                        />
                      </Form.Field>
                      <div className="action">
                        <Button color="teal" disabled={!connected}>
                          Edit
                        </Button>
                      </div>
                    </Form>
